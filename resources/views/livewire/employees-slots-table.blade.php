<div>
    <div>
        ...
        {{-- Modal pour ajouter un coiffeur --}}
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex items-center justify-between d p-4">
                        <div class="flex">
                            ...
                            <button class="ml-4 btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmployeeModal">
                                Nouveau
                            </button>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table id="employeesTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach( $employees as $employee)
                                <tr wire:key = "{{$employee->id}}" class="border-b dark:border-gray-700">
                                    <th scope="row"
